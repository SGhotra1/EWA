...
HTML;
        if($headline == "Bestellung"){
            $script = '<script src="ECMA.js"></script>';
            $css = '<link rel="stylesheet" href="Bestellung.css"/>';
        }
        if($headline == "Lieferstatus"){
            $script = '<script src="StatusUpdate.js"></script>';
            $css =  '<link rel="stylesheet" href="Kunde.css"/>';
        }
        if($headline == "Bäcker" || $headline == "Fahrer"){
            $meta = '<meta http-equiv="refresh" content="5">';
            $css =  '<link rel="stylesheet" href="Fahrer.css"/>';
        }
echo<<<HTML
        $script
        $meta
